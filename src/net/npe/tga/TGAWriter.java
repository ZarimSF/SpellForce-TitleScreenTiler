...
public class TGAWriter {
    ...
    private static int encodeRLE(byte[] buffer, int index, int[] pixels, int start, int count, int elementCount,
            Order order) {
    ...
    private static final byte[] FOOTER = { 0, 0, 0, 0, 0, 0, 0, 0, 84, 82, 85, 69, 86, 73, 83, 73, 79, 78, 45, 88, 70,
            73, 76, 69, 46, 0 }; // TRUEVISION-XFILE
